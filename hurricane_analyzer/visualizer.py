...
"""
Contains all visualization functions for the hurricane analyzer.

This module provides a suite of functions to generate various plots
from xarray Datasets, including pie charts, bar graphs, and advanced
geographic map plots. Each function is self-contained and handles
input validation, plotting, and saving the output to a file.
"""
import os
